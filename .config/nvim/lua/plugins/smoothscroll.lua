return {
  ...
  keys = {
    { "<S-Up>", function() require("neoscroll").ctrl_u({ duration = 50 }) end, desc = "Scroll Up" },
    { "<S-Down>", function() require("neoscroll").ctrl_d({ duration = 50 }) end, desc = "Scroll Down" },
    ...
    { "z<Up>", function() require("neoscroll").zt({ half_win_duration = 200 }) end, desc = "Top Cursor" },
    { "z<Down>", function() require("neoscroll").zb({ half_win_duration = 200 }) end, desc = "Bottom Cursor" },
